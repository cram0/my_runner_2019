...
static const sfIntRect stance_crouch[17] = {{0, 0, 44, 46}, {44, 6, 45, 40},
    {89, 6, 42, 40},
...
void aji_player_stance_crouch(stance *_stance)
{
    ...
    _stance->rect = stance_crouch;
}
static const sfIntRect stance_idle[6] = {{0, 0, 23, 47}, {23, 0, 23, 47},
    {46, 0, 23, 47},
...
void aji_player_stance_idle(stance *_stance)
{
    ...
    _stance->sprite = sfSprite_create();
    _stance->rect = stance_idle;
}

static const sfIntRect stance_running[31] = {{0, 5, 21, 46}, {21, 5, 23, 46},
    {44, 5, 24, 46},
...
void aji_player_stance_running(stance *_stance)
{
    ...
    _stance->sprite = sfSprite_create();
    _stance->rect = stance_running;
}

static const sfIntRect stance_falling[14] = {{0, 17, 43, 45}, {43, 19, 44, 43},
{87, 22, 47, 40}, {134, 23, 47, 39}, {181, 17, 45, 45}, {226, 16, 44, 46},
{270, 12, 45, 50}, {315, 5, 46, 57}, {361, 0, 45, 62}, {406, 14, 45, 48},
{451, 16, 43, 46}, {494, 17, 40, 45}, {534, 18, 36, 44}, {570, 17, 31, 45}
};
...
void aji_player_stance_falling(stance *_stance)
{
    ...
    _stance->sprite = sfSprite_create();
    _stance->rect = stance_falling;
}

static const sfIntRect temp[4] = {{0, 0, 19, 48}, {19, 2, 30, 46},
{49, 5, 44, 43}, {93, 5, 44, 43}
};
