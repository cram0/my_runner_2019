...
{
    _layer->texture = sfTexture_createFromFile("img/background/1_layer.png",
    NULL);
...
{
    _layer->texture = sfTexture_createFromFile("img/background/2_layer.png",
    NULL);
    _layer->sprite_one = sfSprite_create();
    _layer->sprite_two = sfSprite_create();
    _layer->pos_one.x = 0;
...
{
    _layer->texture = sfTexture_createFromFile("img/background/3_layer.png",
    NULL);
    _layer->sprite_one = sfSprite_create();
    _layer->sprite_two = sfSprite_create();
    _layer->pos_one.x = 0;
...
{
    _layer->texture = sfTexture_createFromFile("img/background/4_layer.png",
    NULL);
    _layer->sprite_one = sfSprite_create();
    _layer->sprite_two = sfSprite_create();
    _layer->pos_one.x = 0;
...
{
    _layer->texture = sfTexture_createFromFile("img/background/5_layer.png",
    NULL);
    _layer->sprite_one = sfSprite_create();
    _layer->sprite_two = sfSprite_create();
    _layer->pos_one.x = 0;
