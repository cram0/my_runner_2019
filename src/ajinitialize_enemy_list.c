...
void add_node_enemy_empty(enemy_t *_enemies, int enemy_id, enemy_types_text *_types)
{
...
void add_node_enemy_filled(enemy_t *_enemies, int enemy_id, enemy_types_text *_types, int offset)
{
...
void add_node_enemy(enemy_t *_enemies, int enemy_id, enemy_types_text *_types, int offset)
{
